    ...
    <div
      ...
      <div className="flex flex-col space-y-10 ">
        ...
        <form
          ...
          className="flex flex-col space-y-2 space-x-7 md:w-fit mx-auto">
          <div className="flex space-x-2 " >
            <input {...register("name")} placeholder="Name" className="contactInput rounded-md space-x-10" type="text" />

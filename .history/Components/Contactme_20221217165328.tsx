      ...
      <div className="flex flex-col space-y-10 ">
        ...
        <div className="space-y-10">
          ...
          <form
            ...
            <div className=" space-y-2 flex-col w-3/4   md:flex  md:space-x-2  md:ml-1  scroll-smooth hover:scroll-auto   " >
              <input {...register("name")} placeholder="Name" className="contactInput  w-fit rounded-md " type="text" />

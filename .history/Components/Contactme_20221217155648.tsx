      ...
      <div className="flex flex-col space-y-10 ">
        ...
        <div className="space-y-10">
          ...
          <form
            ...
            className=" sticky flex flex-col space-x-28 space-y-2  md:space-x-1 md:w-fit  mx-auto">
            <div className="flex space-x-2 ml-28 md:ml-1 overflow-x-scroll snap-x  snap-mandatory" >

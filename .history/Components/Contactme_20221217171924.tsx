  ...
  return (
    <div
      ...
      <div className="flex flex-col space-y-10 ">
        <h4 className=" text-lg md:text-4xl mt-5 md:mt-0  font-semibold text-center">Feel Free to reach Us.{" "}
        ...
        <div className="space-y-5 md:space-y-10">
          ...
          <form
            ...
            className="flex flex-col w-3/4 space-y-2  md:space-x-1 md:w-fit  mx-auto">
            <div className=" space-y-2 md:flex  md:space-x-2  md:ml-1" >
              <input {...register("name")} placeholder="Name" className="contactInput rounded-md px-7" type="text" />
              <input {...register("email")} placeholder="Email" className="contactInput rounded-md px-7" type="email" />
            ...
            <button type="submit" className="bg-[#F7AB0A] py-3 px-10 rounded-md  text-black font-bold text-lg animate-pulse">Submit</button>

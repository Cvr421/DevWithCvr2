      ...
      <div className="flex flex-col space-y-10 ">
        ...
        <div className="space-y-10">
          ...
          <form
            ...
            className="flex flex-col w-1/1 h-1/1 space-y-2 mr-5 md:space-x-1 md:w-fit  mx-auto">
            <div className="flex space-x-2  md:ml-1 overflow-x-scroll snap-x  snap-mandatory" >

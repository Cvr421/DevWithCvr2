      ...
      <div className="flex flex-col space-y-10 ">
        ...
        <div className="space-y-10">
          ...
          <form
            ...
            className="flex flex-col w-2/3 h-1/2 space-y-2  md:space-x-1 md:w-fit  mx-auto">
            <div className="flex space-x-2  md:ml-1 scrollbar-hidden overflow-x-scroll snap-x  snap-mandatory   scrollbar-sm scrollbar-track-gray-400/10 scrollbar-thumb-[#F7AB0A]/50 md:scorllbar-hidden" >
